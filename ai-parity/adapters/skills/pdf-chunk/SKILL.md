...
```bash
uv run ~/.agents/skills/pdf-chunk/scripts/pdf_stats.py document.pdf
uv run ~/.agents/skills/pdf-chunk/scripts/extract_pages.py document.pdf --pages "1-5,12-20" --output extracted.txt --manifest extracted.json
```
